...
@Component({
  selector: 'idm-resource-configuration-permissions',
  templateUrl: './resource-configuration-permissions.component.html',
  styleUrls: ['./resource-configuration-permissions.component.css']
})
export class ResourceConfigurationPermissionsComponent implements OnInit {
